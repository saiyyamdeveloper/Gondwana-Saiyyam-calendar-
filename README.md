...
## एडमिन सत्यापन-पैनल (v1.0)

`admin.html` — प्रकाशन से पहले सभी शोध-प्रविष्टियों (शहीद/महापुरुष/क्रांतिकारी/पर्व/स्थल/फ़ोटो/घोषणा) की समीक्षा-कतार।

- **लॉगिन:** ईमेल+पासवर्ड (SHA-256 hash केवल repo में; plaintext कभी नहीं)। भूमिकाएँ: `superadmin` (सब कुछ + खाता-प्रबंधन + रोटेशन) व `admin` (समीक्षा)।
- **कतार:** `review/pending.json` (142 प्रविष्टियां verify-फ़्लैग से auto-seeded) · निर्णय: स्वीकृत/अस्वीकृत/payload-संपादन · audit: `review/decisions.json`।
- **प्रकाशन:** स्वीकृत → verify-फ़्लैग हटेगा; अस्वीकृत → मास्टर से हटेगा। data.js + CSV + JSON अपने आप पुनर्निर्मित → डाउनलोड या PAT से सीधे GitHub push (CI अपने आप चलेगा)।
...
## 🤖 स्व-सत्यापन इंजन (auto-verify)

हर कतार-प्रविष्टि की गहरी cross-जाँच अपने आप: विकिपीडिया HI/EN + विकिडेटा (तिथि/GPS अंक-तुलना) + स्रोत-URL जीवन → **सबूत-डॉसियर** (स्कोर 0-100, हिंदी सारांश, फ़ील्ड-तालिका, विरोध-चेतावनी) → पैनल में बैज + 🔎 डॉसियर।
**हाइब्रिड नीति:** स्कोर ≥90 + ≥2 स्वतंत्र स्रोत + शून्य विरोध → स्वतः स्वीकृत (audit-log सहित); शेष व सभी संवेदनशील निर्णय एडमिन के। वैकल्पिक परत-2 (LLM गहरी research + citation-ढाल) repo-secrets `LLM_PROVIDER`+`LLM_API_KEY` जुड़ते ही सक्रिय। साप्ताहिक digest-मेल सोमवार को।

## 📊 रिपोर्ट-पैनल
एडमिन-पैनल → **📊 रिपोर्ट**: KPI, चार्ट (स्थिति/प्रकार/verdict/प्रवृत्ति/निर्णय-कर्ता), डेटा-गुणवत्ता, विरोध-सूची, स्वतः-स्वीकृति audit, प्राथमिकता-कार्रवाई सूची, अंतिम निर्णय। निर्यात: प्रिंट/PDF · JSON · Markdown। अवधि-फ़िल्टर सहित। सारा डेटा मास्टर-फ़ाइलों से — कुछ भी गढ़ा नहीं जाता।
